...
export class AppointmentService {
  ...
  /**
   * Transfère un engagement (prestation) vers une autre entreprise
   */
  static async transfer(appointmentId: string, targetCompanyId: string): Promise<ApiResponse<Appointment>> {
    return httpClient.post<Appointment>(`/appointments/${appointmentId}/transfer`, { targetCompanyId });
  }
}

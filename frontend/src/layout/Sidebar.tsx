...
export const Sidebar = ({
  ...
  const content = (
    <div
      className={clsx(
        'sidebar-panel flex h-full flex-col',
        variant === 'mobile' ? 'sidebar-panel--mobile h-screen' : 'sidebar-panel--desktop',
    ...
    >
        ...
        <div className="sidebar-panel__brand">
          ...
          {variant === 'desktop' && onToggleVisibility && (
            <button
              ...
              title={isCollapsed ? "Afficher la navigation" : "Masquer la navigation"}
            >
      ...
      <nav className="sidebar-panel__nav flex-1 overflow-y-auto" aria-label="Navigation principale">
  ...
  return (
    <aside
      className={clsx(
        'sidebar-desktop hidden flex-shrink-0 fixed top-0 left-0 z-30 transition-[width] duration-200 lg:block',

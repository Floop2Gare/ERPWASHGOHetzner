...
export const WorkspaceModuleContext = createContext<WorkspaceModuleConfig | null>(null);
        ...
        <div className="flex min-h-screen flex-col lg:flex-row lg:items-start">
          ...
          <div 
            className={clsx(
              ...
              !isDesktopSidebarHidden && isCompactViewport && 'workspace-content-with-sidebar-collapsed',
              !isDesktopSidebarHidden && !isCompactViewport && 'workspace-content-with-sidebar'
            )}
          >
            <Topbar

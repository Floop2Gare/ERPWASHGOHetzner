...
export function useBackendSync() {
   ...
   */
  useEffect(() => {
    console.log('[BackendSync] Hook initialisé - Synchronisation automatique DÉSACTIVÉE temporairement');
   ...
   */
  useEffect(() => {
    // Synchronisation désactivée pour éviter les erreurs

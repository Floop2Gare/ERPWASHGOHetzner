...
const PlanningPage = () => {
  ...
  const slotStatusOverrides = useMemo(() => {
    return new Map<string, EngagementStatus>();
  }, []);
                  ...
                  {monthDays.map((day, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={clsx(
                          'relative aspect-square rounded-2xl p-2 text-sm font-medium transition-all flex flex-col items-start justify-start',
